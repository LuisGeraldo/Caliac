...
<% 
		//Materias = request.getParameter("CMaterias");
		Materias = Integer.parseInt(request.getParameter("CMaterias")); 
...
<% 
	...
	if(SumaCredito > 27){
		out.print("<center><p id='Error'>La cantidad de créditos excede el maximo</p></center>");
	}else{
		double IndiceRed = Math.round(Indice*Math.pow(10,2))/Math.pow(10,2);
		out.print("<center><h1 id='ComoUsar'>Índice: "+(IndiceRed)+"</h1></center>");
		}
	} 
%>
		</article>
